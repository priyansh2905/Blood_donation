...
const Footer = () => {
	return (
		<div className="bg-gray-100 flex flex-col items-center overflow-auto p-4 gap-4">
			<div className="flex flex-row justify-between gap-20 overflow-visible">
				<div className="bg-white min-w-60 rounded-2xl">
					<img src="logo_bloodbridge_1.jpg" alt="" className="rounded-2xl h-full w-full" />
					{/* <span>Saving lives, one donation at a time.</span> */}
				</div>
				<div className="p-4 rounded-2xl bg-white shadow min-w-60 min-h-45">
					...
					<ul className="mt-2 space-y-2">
						...
						<Link to="/login">
							<li className="hover:underline">Admininstator Login</li>
						</Link>
					</ul>
				</div>
				<div className="w-full md:w-1/3 p-4 rounded-2xl bg-white shadow min-w-60 min-h-45">
					<h3 className="text-xl font-semibold">Contact Us</h3>
					<p className="mt-2">123 BloodConnect Ave</p>
