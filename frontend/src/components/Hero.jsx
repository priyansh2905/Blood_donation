...
const Hero = () => {
  return (
    <div className="bg-[url('/hero1_1.jpg')] bg-no-repeat bg-cover bg-center h-[85vh] px-[200px]">
      <div className="flex flex-col text-white w-[50%] pt-[10%]">
        ...
        <div className="flex items-center mt-[20px]">
          ...
          <button className="bg-gray-500 p-[10px] w-[200px] text-white cursor-pointer mr-9">CALL : (+125) 262 34</button>
